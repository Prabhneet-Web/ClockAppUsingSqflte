...
class CustomColors{
  ...
  static Color secondHandColor = Colors.orange.shade700;
  static Color minuteHandStartColor = const Color(0xFF748EF6);
  static Color minuteHandEndColor = const Color(0xFF77DDFF);
